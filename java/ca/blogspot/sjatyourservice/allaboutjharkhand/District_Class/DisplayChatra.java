...
public class DisplayChatra extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;

	String[] data = { "Headquarter\t- Chatra",
					  "Formation\t- 1991",
					  "Area\t- 3,718sq.km",
					  "Total Population\t- 10,42,886",
					  "Sex Ratio\t- 967",
					  "Total Literacy\t- 60.18%",
					  "Population Density\t-280",
					  "Tourist places \t-Kolhua Mountain, Bhadrakali temple   "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_chatra);
