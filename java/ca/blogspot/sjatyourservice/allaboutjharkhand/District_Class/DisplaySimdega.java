...
public class DisplaySimdega extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Medininagar","Formation\t-1892","Area\t-4,393sq.km","Total Population\t-19,39,869","Male Population\t-10,06,302","Female Population\t-9,33,567","Infant Population\t-3,10,478","Growth Rate\t-26.17%"};
	@Override
