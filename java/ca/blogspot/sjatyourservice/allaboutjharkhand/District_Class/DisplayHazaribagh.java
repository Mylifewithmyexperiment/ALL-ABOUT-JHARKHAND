...
public class DisplayHazaribagh extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Hazaribagh ",
					  "Formation\t-1833 ",
					  "Area\t- 3,555sq.km",
					  "Total Population\t- 17,34,495",
					  "Sex Ratio\t- 947",
					  "Total Literacy\t-69.75 %",
					  "Population Density\t-488",
					  "Tourist places \t-  Konark Dam, SurajKund,Chandrapura Deer Park "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_hazaribagh);
