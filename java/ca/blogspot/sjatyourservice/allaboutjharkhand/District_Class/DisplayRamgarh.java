...
public class DisplayRamgarh extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;

	String[] data = { "Headquarter\t-Ramgarh ",
					  "Formation\t- 2007",
					  "Area\t- 1,341sq.km",
					  "Total Population\t-9,49,443 ",
					  "Sex Ratio\t-921 ",
					  "Total Literacy\t- 73.13%",
					  "Population Density\t-708",
					  "Tourist places \t-  Chhinmastika Devi(Rajrappa),patratu Dam "};


	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_ramgarh);
