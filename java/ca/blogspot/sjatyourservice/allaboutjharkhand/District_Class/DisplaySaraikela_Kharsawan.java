...
public class DisplaySaraikela_Kharsawan extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Saraikela ",
					  "Formation\t- 2001",
					  "Area\t- 2,657sq.km",
					  "Total Population\t-10,65,056 ",
					  "Sex Ratio\t- 956",
					  "Total Literacy\t- 67.70%",
					  "Population Density\t-401",
					  "Tourist places \t-Chandil Dam   "};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_saraikela__kharsawan);
