...
public class DisplayKhunti extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Khunti",
					  "Formation\t- 2007",
					  "Area\t- 2,535sq.km",
					  "Total Population\t- 5,31,885",
					  "Sex Ratio\t-997 ",
					  "Total Literacy\t- 63.86%",
					  "Population Density\t-210",
					  "Tourist places \t-  Birsa Deer Park "};
	@Override
