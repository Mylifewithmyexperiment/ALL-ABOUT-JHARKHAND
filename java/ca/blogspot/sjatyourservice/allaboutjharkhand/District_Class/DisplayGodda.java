...
public class DisplayGodda extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Godda",
					  "Formation\t-1983",
					  "Area\t-2,110sq.km",
					  "Total Population\t-13,13,551",
					  "Sex Ratio\t-938",
					  "Total Literacy\t-56.40%",
					  "Population Density\t-622",
					  "Tourist places \t- Temple of Maa Yogini on the hill of Barakopa "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_sahebganj);
