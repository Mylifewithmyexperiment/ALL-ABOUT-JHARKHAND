...
public class DisplayPalamu extends AppCompatActivity {

	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Medininagar",
					  "Formation\t-1892",
					  "Area\t-4,393sq.km",
					  "Total Population\t-19,39,869",
					  "Sex Ratio\t-928",
					  "Total Literacy\t-63.63%",
					  "Population Density\t-442",
					  "Tourist places \t- Plalmau fort, Hot stream of Tatapani"};


	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_palamu);
		toolbar = (Toolbar) findViewById(R.id.toolbar);
		setSupportActionBar(toolbar);
		getSupportActionBar().setDisplayHomeAsUpEnabled(true);
		lv2 = (GridView) findViewById(R.id.lv2);
		DisplayPalamu.MyAdapter adapter = new DisplayPalamu.MyAdapter(this,data);
