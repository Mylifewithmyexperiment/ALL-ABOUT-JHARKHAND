...
public class DisplayKoderma extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;

	String[] data = { "Headquarter\t- Koderma",
					  "Formation\t- 1994",
					  "Area\t- 1,494sq.km",
					  "Total Population\t- 7,16,259",
					  "Sex Ratio\t- 950",
					  "Total Literacy\t-66.84%",
					  "Population Density\t-282",
					  "Tourist places \t-Tilaiya Dam   "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_koderma);
