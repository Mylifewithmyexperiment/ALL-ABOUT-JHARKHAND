...
public class DisplayPakur extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Pakur ",
					  "Formation\t- 1994",
					  "Area\t- 1,806sq.km",
					  "Total Population\t-9,00,422 ",
					  "Sex Ratio\t- 989",
					  "Total Literacy\t-48.82 %",
					  "Population Density\t-497",
					  "Tourist places \t-Small fort of Aliganj, Birkhata fort"};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_pakur);
