...
public class DisplayLohardaga extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Lohardaga",
					  "Formation\t- 1983",
					  "Area\t- 1,502sq.km",
					  "Total Population\t-4,61,790 ",
					  "Sex Ratio\t- 985",
					  "Total Literacy\t-67.61 %",
					  "Population Density\t-307",
					  "Tourist places \t-Khakparta Shiv Mandir, Ajay Uddyan,Serongdag "};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_lohardaga);
