...
public class DisplaySahebganj extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Sahebganj",
					  "Formation\t- 1983",
					  "Area\t- 2,063sq.km",
					  "Total Population\t-11,50,567 ",
					  "Sex Ratio\t- 952",
					  "Total Literacy\t-52.04 %",
					  "Population Density\t-558",
					  "Tourist places \t- Daminikoh, Rajmahal, Bhagnadih  "};
