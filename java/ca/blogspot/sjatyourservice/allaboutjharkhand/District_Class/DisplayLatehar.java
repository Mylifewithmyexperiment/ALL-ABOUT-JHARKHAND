...
public class DisplayLatehar extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Latehar",
					  "Formation\t-2001",
					  "Area\t-4,291sq.km",
					  "Total Population\t-7,26,978",
					  "Sex Ratio\t-967",
					  "Total Literacy\t-59.51%",
					  "Population Density\t-169",
					  "Tourist places \t- Neterhat, Belta National park, Lodha fall "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_latehar);
