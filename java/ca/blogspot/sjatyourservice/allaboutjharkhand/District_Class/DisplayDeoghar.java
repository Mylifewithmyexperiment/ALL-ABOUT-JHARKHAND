...
public class DisplayDeoghar extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;

	String[] data = { "Headquarter\t-Deoghar",
					  "Formation\t-1 june,1996",
					  "Area\t-2,477sq.km",
					  "Sex Ratio\t-925",
					  "Population Density\t-602",
					  "Total Literacy\t-64.85%",
					  "Total Population\t-14,92,073",
					  "Tourist places \t- Baidhnath Dham Temple, Trikutachal Aashram, Yugal " +
							  "temple,Leela Temple, Bakulia fall" +
							  " "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_ranchi);
