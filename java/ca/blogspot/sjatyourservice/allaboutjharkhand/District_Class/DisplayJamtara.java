...
public class DisplayJamtara extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Jamtara",
					  "Formation\t-2001",
					  "Area\t-1,811sq.km",
					  "Sex Ratio\t-954",
					  "Population Density\t-437",
					  "Total Literacy\t-64.59%",
					  "Total Population\t-7,91,042",
					  "Tourist places \t- Kalyaneshwari Temple, Maithan Dam "};

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_jamtara);
