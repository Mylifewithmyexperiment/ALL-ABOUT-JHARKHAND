...
public class DisplayEast_Singhbhum extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Jamshedpur ",
					  "Formation\t- 1990",
					  "Area\t- 3,562sq.km",
					  "Total Population\t-22,93,919 ",
					  "Sex Ratio\t- 949",
					  "Total Literacy\t- 75.49%",
					  "Population Density\t-644",
					  "Tourist places \t-Jublee Park, Dimna Lake, Dharagiri   "};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_east__singhbhum);
