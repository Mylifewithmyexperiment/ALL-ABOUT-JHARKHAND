...
public class DisplayWest_Singhbhum extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Chaibasa",
					  "Formation\t- 1990",
					  "Area\t- 7,224sq.km",
					  "Total Population\t- 15,02,338",
					  "Sex Ratio\t- 1005",
					  "Total Literacy\t- 58.63%",
					  "Population Density\t-208",
					  "Tourist places \t- Hirni fall, Lumpugatu fall   "};
	@Override
