...
public class DisplayGiridih extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Giridih",
					  "Formation\t- 1972",
					  "Area\t- 4962sq.km",
					  "Total Population\t-24,45,474 ",
					  "Sex Ratio\t- 944",
					  "Total Literacy\t- 63.14%",
					  "Population Density\t-493",
					  "Tourist places \t- Parasnath "};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_giridih);
