...
public class DisplayDumka extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;

	String[] data = { "Headquarter\t-Dumka",
					  "Formation\t-1855",
					  "Area\t-3,761sq.km",
					  "Total Population\t-13,21,442",
					  "Sex Ratio\t-977",
					  "Total Literacy\t-61.02%",
					  "Population Density\t-351",
					  "Tourist places \t- Basukinath Temple, Masanjor Dam "};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_dumka);
