...
public class DisplayGarhwa extends AppCompatActivity  {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Garhwa",
					  "Formation\t-1991",
					  "Area\t-4,093sq.km",
					  "Total Population\t-13,22,784",
					  "Sex Ratio\t-935",
					  "Total Literacy\t-60.33%",
					  "Population Density\t-323",
					  "Tourist places \t- Vanshidhar Temple, Gursindu fall "};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_garhwa);
